...
for subj = subjIn
    ...
    video_path = ['E:/outdoorData/NP/rawVid_undistorted.mp4']; % path directly to video (undistorted)
    
    % pull from Rocks.mat / Woodchips.mat
    %data_path = ['../' sub_str  '.csv'];
    data_path = ['E:/outdoorData/NP/raw_data_export/2023_07_25/gaze.csv'];
    flow_path = ['../' sub_str '_Berk_flo.hdf5']; % path to .flo files
    ret_flow_path = ['E:/outdoorOutputVid/retflow_flo/']; %path to output matlab flow files (retinal ref)
